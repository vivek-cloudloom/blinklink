  ...
  return (
    <>
      <div className="solutions-page">
        ...
        <div className="solutions-page-item">
          <div className="container justify-content-center d-flex flex-column h-100">
            <h4 className="typography-5">Manage your Social Media</h4>
            <p className="typography-6">
              You are the platform. Social Medias are you distrubition channels.
              Manage and grow your audiences from BlinkLink.{" "}
            </p>
            <img className="social-image" src="/images/features/social.png" />

            <div
              className="d-flex gap1 position-relative w-100"
              style={{ top: "-160px" }}
            >
              <div
              ...
              <div className="d-flex flex-column gap1" style={{ width: "60%" }}>
          ...
          <div className="container align-items-center d-flex justify-content-center flex-column h-100">
            <div className="align-items-center d-flex">
              ...
              <div className="p-5">
                ...
                Lets take your Influence to the next level <span className="text-danger">♥️</span>
                </h4>
                <div>
              ...
              <img src="/images/features/influence.png" />
            </div>
          </div>
        </div>
      </div>
